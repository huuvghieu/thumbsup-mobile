...
class ProfileReserveOrderDetail extends StatelessWidget {
  const ProfileReserveOrderDetail({super.key});
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: Column(children: [
          ...
          Container(
            height: 50 * fem,
            margin: EdgeInsets.fromLTRB(10 * fem, 0 * fem, 10 * fem, 50 * fem),
            child: Text(
