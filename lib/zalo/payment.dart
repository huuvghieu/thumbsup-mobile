...
import 'package:my_app/model/create_order_response.dart';
import 'package:my_app/utils/endpoints.dart';
import 'package:my_app/utils/util.dart' as utils;
...
class ZaloPayConfig {
  ...
  static const String appUser = "my_app";
...
Future<CreateOrderResponse?> createOrder(int price) async {
  ...
  // await launchUrl(Uri.parse("2554:"));
